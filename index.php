...
<body>
    ...
    <div class="container p-3 mb-2 bg-danger text-white bg-gradient"><!-- Formulario para agregar un nuevo registro -->
...
<footer class="container p-3 mb-2 bg-dark text-white bg-gradient" >
    <ul class="list-unstyled ">
      <li class="">CConceptualización de servicios en la nube</li>
      <li class="">HECTOR ALEJANDRO ZUBIRIA PEREZ</li>
      <li class="">222959514</li>
      <li class="">Awexzubiria@gmailcom</li>
    </ul>
  </footer>
